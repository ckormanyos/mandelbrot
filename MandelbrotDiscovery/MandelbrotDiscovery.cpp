...
static_assert(MANDELBROT_CALCULATION_PIXELS_X == MANDELBROT_CALCULATION_PIXELS_Y,
              "Error: This program is only compilable for square geometry");

using mandelbrot_numeric_type = boost::multiprecision::number<boost::multiprecision::cpp_dec_float<MANDELBROT_CALCULATION_DIGITS10>, boost::multiprecision::et_off>;
