...
This project uses [`Boost.Multiprecision`](https://www.boost.org/doc/libs/1_90_0/libs/multiprecision/doc/html/index.html)
to implement a high-precision Mandelbrot iteration and visualization.
Graphic file creation uses
[`Boost.Gil`](https://www.boost.org/doc/libs/1_90_0/libs/gil/doc/html/index.html).
...
The following design goals have been incorporated.
  ...
  - Graphical representation uses [`Boost.Gil`](https://www.boost.org/doc/libs/1_90_0/libs/gil/doc/html/index.html) in combination with the JPEG-6b library (see [below](#Adaptions-of-and-Notes-on-jpeg-6b)).
...
The commands are shown below, where you need to specialize `--boost`, `--my_cc` and `--stdcc` accordingly.
Optional parameters `--dxtra` and `--ixtra` can be used to set one additional extra definition or include path, if needed.
...
This image has the following features and parameters.
  ...
  - Computed with $2,000$ iteratons using the `cpp_dec_float` type from [`Boost.Multiprecision`](https://www.boost.org/doc/libs/1_90_0/libs/multiprecision/doc/html/index.html) instantiated with $37$ decimal digits of precision.
...
This image has the the following features and parameters.
  ...
  - Computed with $15,000$ iteratons using the `cpp_dec_float` type from [`Boost.Multiprecision`](https://www.boost.org/doc/libs/1_90_0/libs/multiprecision/doc/html/index.html) instantiated with $95$ decimal digits of precision.
...
This image has the the following features and parameters.
  ...
  - Computed with $60,000$ iteratons using the `cpp_dec_float` type from [`Boost.Multiprecision`](https://www.boost.org/doc/libs/1_90_0/libs/multiprecision/doc/html/index.html) instantiated with $95$ decimal digits of precision.
...
The following adaptions have been performed.
  ...
  - Test/compile only the subset of functions empirically found to be needed for use with [Boost.Gil](https://www.boost.org/doc/libs/1_90_0/libs/gil/doc/html/index.html).
