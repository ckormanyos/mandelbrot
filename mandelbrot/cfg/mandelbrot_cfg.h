...
//
  ...
  #elif defined(MANDELBROT_USE_FLOAT128)

  #include <boost/multiprecision/float128.hpp>

  #define MANDELBROT_COORD_PNT_NUMBER_TYPE(MB_DIGITS10) ::boost::multiprecision::float128 // NOLINT(cppcoreguidelines-macro-usage)
