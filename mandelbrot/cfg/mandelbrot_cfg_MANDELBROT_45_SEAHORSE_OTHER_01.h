...
//
  ...
  //constexpr char MANDELBROT_POINT_DX_HALF[]         = "1.0E-24";
  constexpr char MANDELBROT_POINT_DX_HALF[]         = "1.0E-21";
  constexpr char MANDELBROT_POINT_CENTER_X[]        = "-0.745605122368264995520769505";
  constexpr char MANDELBROT_POINT_CENTER_Y[]        = "+0.112859495427252849953537530";
